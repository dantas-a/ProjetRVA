...
public static class GameLogic
{
    ...
    public static int interactionPilleur = 0; // 0 : pas parlé au pilleur de tombe; 1 : parlé au pilleur à l'acte2; 2 : artéfact recupéré; 3 : artéfact rendu au pilleur; 4 : artéfact utilisé pour le rituel
